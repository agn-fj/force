...
func runExport(cmd *Command, args []string) {
	...
	query := ForceMetadataQuery{
		...
		{Name: "ApexTrigger", Members: []string{"*"}, FolderTypeName: "", AllowsWildcard: true},
		...
		{Name: "Dashboard", Members: []string{"*"}, FolderTypeName: "DashboardFolder", AllowsWildcard: false},
		//{Name: "DataCategoryGroup", Members: []string{"*"}},
		{Name: "Document", Members: []string{"*"}, FolderTypeName: "DocumentFolder", AllowsWildcard: false},
		{Name: "EmailTemplate", Members: []string{"*"}, FolderTypeName: "EmailFolder", AllowsWildcard: false},
		...
		{Name: "Report", Members: []string{"*"}, FolderTypeName: "ReportFolder", AllowsWildcard: false},
		...
		{Name: "Workflow", Members: []string{"*"}, FolderTypeName: "", AllowsWildcard: true},
	}
