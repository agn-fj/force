...
func runExport(cmd *Command, args []string) {
	...
	query := ForceMetadataQuery{
		...
		{Name: "ApexTrigger", Members: []string{"*"}, FolderTypeName: ""},
		...
		{Name: "Dashboard", Members: []string{"*"}, FolderTypeName: "DashboardFolder"},
		//{Name: "DataCategoryGroup", Members: []string{"*"}},
		{Name: "Document", Members: []string{"*"}, FolderTypeName: "DocumentFolder"},
		{Name: "EmailTemplate", Members: []string{"*"}, FolderTypeName: "EmailFolder"},
		...
		{Name: "Report", Members: []string{"*"}, FolderTypeName: "ReportFolder"},
		...
		{Name: "Workflow", Members: []string{"*"}, FolderTypeName: ""},
	}
